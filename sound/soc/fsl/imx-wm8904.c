...
static int imx_wm8904_probe(struct platform_device *pdev)
{
	...
	for (i = 0; i < 2; i++) {
		imx_wm8904_dai[i].codecs->name = NULL;
		imx_wm8904_dai[i].codecs->of_node = codec_np;
		imx_wm8904_dai[i].cpus->dai_name = NULL;
		imx_wm8904_dai[i].cpus->of_node = sai_np[i];
		imx_wm8904_dai[i].platforms->name = NULL;
		imx_wm8904_dai[i].platforms->of_node = sai_np[i];
	}
